...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex align-items-center">
        ...
        <h6 class="m-0 font-weight-bold text-warning">Form Tambah Barang Keluar</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('barang-keluar.store') }}" method="POST" id="formBarangKeluar">
            ...
            <div class="form-group">
                ...
                <input type="number"
                    ...
                    min="1" placeholder="Masukkan jumlah barang keluar">
                @error('jumlah_keluar')
            ...
            <!-- Sisa Stok (otomatis) -->
            <div class="form-group">
                <label>Sisa Stok Setelah Keluar</label>
                <input type="text" class="form-control" id="sisa_stok"
                    value="-" readonly style="background-color: #f8f9fc;">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="keterangan" name="keterangan"
                    rows="3" placeholder="Contoh: Digunakan untuk pengecatan lambung kapal">{{ old('keterangan') }}</textarea>
            </div>
...
<script>
    ...
    function hitungSisa() {
        ...
        const sisaEl = document.getElementById('sisa_stok');

        if (stok >= 0 && jumlah > 0) {
            const sisa = stok - jumlah;
            sisaEl.value = sisa;
            sisaEl.style.backgroundColor = sisa < 0 ? '#ffe0e0' : '#f8f9fc';
            sisaEl.style.color = sisa < 0 ? 'red' : 'black';
        } else {
            sisaEl.value = '-';
            sisaEl.style.backgroundColor = '#f8f9fc';
    ...
    document.getElementById('jumlah_keluar').addEventListener('input', hitungSisa);
